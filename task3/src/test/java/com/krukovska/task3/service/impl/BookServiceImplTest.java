...
class BookServiceImplTest {
    ...
    @Autowired
    private BookServiceImpl bookCriteriaService;
    ...
    @Test
    void findAllByAuthorGroupSuccess() {
        List<Book> books = bookCriteriaService.findAllByAuthorGroup(asList(6L, 7L));
    ...
    @Test
    void findAllByAtLeastOneAuthorFromGroupOneResult() {
        List<Book> books = bookCriteriaService.findAllByAtLeastOneAuthor(asList(6L, 8L));
        assertEquals(1, books.size());
    }
    ...
    @Test
    void findAllByAtLeastOneAuthorFromGroupMultipleResult() {
        List<Book> books = bookCriteriaService.findAllByAtLeastOneAuthor(asList(2L, 3L, 8L));
    ...
    @Test
    void findByMultipleGenresSuccess() {
        List<Book> books = bookCriteriaService.findAllByMultipleGenres(asList(3L, 5L));
        assertEquals(2, books.size());
    }
    ...
    @Test
    void findByAtLeastOneGenreSuccess() {
        List<Book> books = bookCriteriaService.findAllByAtLeastOneGenre(asList(3L, 5L));
        assertEquals(3, books.size());
    }
